...
```
  ...
  --nocleanup           Leave grootds and test.* datadir on exit or error
  --noshutdown          Don't stop grootds after the test execution
  --srcdir=SRCDIR       Source directory containing grootd/dash-cli
                        (default: ../../src)
