...
[From the groot github repo](https://github.com/dashpay/dash/blob/master/doc/masternode_conf.md)
...
## Update groot.conf on server

If you generated a new masternode private key, you will need to update the remote `groot.conf` files.

Shut down the daemon and then edit the file.

```nano .grootcore/dash.conf```

### Edit the masternodeprivkey
If you generated a new masternode private key, you will need to update the `masternodeprivkey` value in your remote `groot.conf` file.
...
and comparing with the official explorer at https://explorer.groot.org/chain/Dash
...
Search your Masternodes on https://grootninja.pl/masternodes.html
