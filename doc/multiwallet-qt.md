...
Only requiring some minor changes is groot.cpp.
...
Changes to groot.cpp
----------------------
groot.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
