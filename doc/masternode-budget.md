...
Format: ```mngovernance prepare proposal-name url payment-count block-start groot-address monthly-payment-dash```
...
Format: ```mngovernance submit proposal-name url payment-count block-start groot-address monthly-payment-dash fee-tx```
...
The following RPC commands are supported:
 ...
 - mngovernance "command"... ( "passphrase" )
  ...
  - vote               - Vote on a proposal by single masternode (using groot.conf setup)
