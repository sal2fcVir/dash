...
const char * const BITCOIN_CONF_FILENAME = "groot.conf";
const char * const BITCOIN_PID_FILENAME = "grootd.pid";
...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL)
    {
        ...
        if (ptrCategory.get() == NULL)
        {
            ...
            // "groot" is a composite category enabling all Dash-related debug output
            if(ptrCategory->count(string("groot"))) {
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()){
        // Create empty groot.conf if it does not excist
    ...
    {
        // Don't overwrite existing settings so command line settings override groot.conf
