...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("groot.org", "dnsseed.dash.org"));
        vSeeds.push_back(CDNSSeedData("grootdot.io", "dnsseed.dashdot.io"));
        vSeeds.push_back(CDNSSeedData("masternode.io", "dnsseed.masternode.io"));
        vSeeds.push_back(CDNSSeedData("grootpay.io", "dnsseed.dashpay.io"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("grootdot.io",  "testnet-seed.dashdot.io"));
